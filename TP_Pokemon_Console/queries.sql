...
VALUES
	...
	('Méga-Dracaufeu', 1.7, 100.5, 78, 104, 2),
...
VALUES
	...
	('Élekable', 1.8, 138.6, 75, 123, 2, 15, 0),
	('Arceus', 3.2, 320.0, 120, 120, 4, 30, 0),
	('Zébibron', 0.8, 29.8, 45, 60, 4, 5, 0),
	('Silvallié', 2.3, 100.5, 95, 95, 2, 6, 1),
